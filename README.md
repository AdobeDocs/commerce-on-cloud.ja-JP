...
テクニカルライター、プログラムマネージャー、またはAdobe Experience Cloud ソリューションのプロダクトチームの開発者で、技術記事の投稿や作成を担当する場合は、`https://github.com/Adobe-Enterprise-Docs/commerce-on-cloud.en`のプライベートリポジトリを使用する必要があります。
