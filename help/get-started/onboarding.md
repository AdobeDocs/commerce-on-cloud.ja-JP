---
title: '[!DNL Onboarding]からCommerceへ'
description: クラウドアカウントにアクセスし、Adobe Commerce on cloud インフラストラクチャプロジェクトを設定します。
role: Admin
...
# [!DNL Onboarding]からCommerceへ

AdobeでCommerce オンクラウドインフラストラクチャのサブスクリプションをアクティベートすると、最初のプロジェクトおよびコードアクセスは、ライセンスオーナー（アカウントオーナー）として指定されたユーザーのみが利用できます。

ライセンスオーナーとは、Adobe Commerce on cloud インフラストラクチャアカウントの支払いやその他のビジネス関連トランザクションを管理するビジネスまたは金融機関の人物です。 この人物は、Adobeとの連絡窓口として機能します。 アカウントのライセンスオーナーを変更する必要がある場合は、Adobe アカウントチームにお問い合わせください。

ライブデプロイメント用のサイト開発を開始できるように、プロジェクトをすばやくオンボーディングするには、必要なセットアップと[!DNL onboarding] タスクを完了する必要があります。 通常、ライセンス所有者は、管理者アクセスを保護し、設定、カスタマイズ、開発作業に役立つ管理者ユーザーを作成して、プロセスを開始します。
...
ライセンス所有者は、ユーザーアカウントを追加して、コードへのアクセス、ブランチの管理、チケットの入力、サポート環境を提供できます。 これらのユーザーアカウントには、社内開発、コンサルタント、ソリューションの専門家が含まれます。
...
[[!DNL Cloud Console]](cloud-console.md)を使用して、プロジェクトの管理、ユーザーアカウントの追加、ストアの開発を開始できます。 ライセンス所有者、技術管理者ユーザー、および開発者は、[!DNL Cloud Console]を使用して、すべての環境とブランチ、環境変数、環境設定、およびルートを管理できます。
