...
1. [ ファイルシステム所有者](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/prerequisites/file-system/configure-permissions) アカウントでローカル ワークステーションにログインします。
