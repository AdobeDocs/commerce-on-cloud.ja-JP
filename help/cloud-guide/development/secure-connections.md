...
>[!NOTE]
>ステージング環境および実稼動環境で、sFTP 接続が _クラウドプロジェクトに追加_**する必要がない** 汎用 [ ユーザー用の場合は、](../project/user-access.md) 公開 [ キーを添付した ](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide.html#submit-ticket)Adobe Commerce サポートチケットを送信 **** する必要があります。 **秘密の SSH キーを入力しないでください。**
