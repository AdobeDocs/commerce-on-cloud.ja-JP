...
>[!TIP]
>
>パイプラインのデプロイメントのオーバーライドスキームについて詳しくは、_設定ガイド_&#x200B;の[設定管理](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/deployment/technical-details)を参照してください。
...
_設定ガイド_&#x200B;の[機密設定またはシステム固有の設定](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/paths/config-reference-sens)の一覧を参照してください。
