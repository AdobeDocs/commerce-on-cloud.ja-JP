...
_設定ガイド_&#x200B;の「[Valkey](https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/cache/valkey/config-valkey.html){target="_blank"}の設定」を参照してください。
