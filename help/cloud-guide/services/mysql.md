...
上記の例の`properties`は、パフォーマンスのベストプラクティスガイド [&#128279;](https://experienceleague.adobe.com/en/docs/commerce-operations/performance-best-practices/configuration#indexers)で推奨されているとして、デフォルトの`optimizer`設定を変更します。
