...
- ![ 修正アイコン ](../../assets/fix.svg)**パッチ** - [Commerce ナレッジベース」（チケット AC-15867 および ACSD-68617）に記載されている問題 ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997)JS の縮小とバンドルが有効な場合にチェックアウトが失敗する）を修正しました。<!-- MCLOUD-14191 -->
