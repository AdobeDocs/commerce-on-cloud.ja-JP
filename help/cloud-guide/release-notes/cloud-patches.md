...
- ![&#x200B; 修正アイコン &#x200B;](../../assets/fix.svg)**パッチ** - [Commerce ナレッジベース」（チケット AC-15867 および ACSD-68617）に記載されている問題 &#x200B;](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-27997)JS の縮小とバンドルが有効な場合にチェックアウトが失敗する）を修正しました。<!-- MCLOUD-14191 -->
