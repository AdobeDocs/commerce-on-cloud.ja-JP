...
- ![&#x200B; 修正アイコン &#x200B;](../../assets/fix.svg) **パッチ** - [JS の縮小とバンドルが有効な場合にチェックアウトが失敗する &#x200B;](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-27997) 問題の修正については、*Commerce ナレッジベース* に記載されています。
