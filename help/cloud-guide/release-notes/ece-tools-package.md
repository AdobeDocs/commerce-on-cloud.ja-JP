...
- ![新しいアイコン ](../../assets/new.svg) **RabbitMQ** - RabbitMQ 4.2のサポートを追加しました。<!-- MCLOUD-14374 -->
- ![新しいアイコン ](../../assets/new.svg) **Opensearch** – 複数のMagento バージョンに対するOpensearch 2.19および3.5のサポートを追加しました。<!-- MCLOUD-14682 -->
- ![新しいアイコン ](../../assets/new.svg) **Valkey** - Valkey 8.1および9のサポートを追加しました。<!-- MCLOUD-14784/MCLOUD-14625 -->
- ![新しいアイコン ](../../assets/new.svg) **ActiveMQ** - ActiveMQ 2.5.1のサポートを追加しました。<!-- MCLOUD-14683 -->
- ![新しいアイコン ](../../assets/new.svg) **MariaDB** - MariaDB 11.8および12.2のサポートを追加しました。<!-- MCLOUD-14628 -->
- ![ アイコンの修正](../../assets/fix.svg) **設定とデプロイメント** - クラウド デプロイメントの警告の修正、コンポーザーのテストの非推奨化の更新、デプロイメント時のECE ツールのバージョンの表示修正<!-- MCLOUD-14822 -->
...
- ![ アイコンの修正](../../assets/fix.svg) **検証ツールの修正**-RabbitMQ 4.0の検証ツールの修正<!-- MCLOUD-13560 -->
...
- ![新しいアイコン ](../../assets/new.svg) **Adobe Commerce**&#x200B;のAdobe I/O Eventsのサポートを追加しました。 拡張機能の開発者は、[Adobe I/O Events](https://developer.adobe.com/events/docs/) フレームワークを使用して、[Adobe App Builder](https://developer.adobe.com/app-builder/docs/intro_and_overview/)用に作成されたアプリケーションにCommerce イベント情報をCloud インスタンスから送信できるようになりました。 Adobe Commerce用Adobe I/O Eventsは、パートナープレビューで表示されています。<!-- CEXT-932 -->
...
>[!NOTE]
>
>ECE-Tools バージョン 2002.1.0にアップデートする前に、[後方互換性のない変更点](backward-incompatible-changes.md)を確認して、Adobe Commerce on cloud infrastructure プロジェクトの設定またはプロセスを更新する必要がある変更点について確認してください。
